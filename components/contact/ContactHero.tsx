      ...
      <Container size="xl" className="relative z-10">
        <Stack gap="lg" align="center" className="text-center">
          ...
          <p className="reveal-up stagger-2 text-muted-foreground max-w-2xl text-base leading-relaxed md:text-lg">
            Whether you need brewing advice, gifting support, or bulk sourcing guidance, our team is
            here to help with thoughtful recommendations.
          </p>
